...
export class DocsComponent implements OnInit {
  ...
  ngDoCheck(): void {
    ...
    if (url[0].path === "faq" ) {
      ...
      this.seoService.setTitle('API Documentation - Bitcoin Explorer | BTCmempool.org', true);
      if (this.stateService.network === 'liquid' || this.stateService.network === 'liquidtestnet' ) {
        ...
        this.seoService.setDescription('Explore the btcmempool.org REST API documentation to access information on addresses, transactions, blocks, fees, mining, the Lightning Network, and more.');
      }
      ...
      if( this.stateService.network === 'liquid' || this.stateService.network === 'liquidtestnet' ) {
        ...
        this.seoService.setDescription('Explore the btcmempool.org WebSocket API documentation to access information on blocks, mempools, transactions, addresses, and more.');
      }
    } else {
      this.activeTab = 3;
